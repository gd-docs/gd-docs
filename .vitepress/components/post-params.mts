export default {
    "descriptions": {
        ...
        "uuid": "The player's user ID. See the previous format <a href=\"/topics/encryption/id#uuid\">here</a>",
        ...
        "dvs": "A number representing the OS platform the player is using. Corresponds to the <a href=\"https://docs.cocos2d-x.org/api-ref/cplusplus/V2.2/dd/d96/_c_c_platform_config_8h.html\" target=\"_blank\" rel=\"noreferrer\">Cocos2d <code>CC_TARGET_PLATFORM</code> macro</a>: 1 for iOS, 2 for Android, 3 for Windows, 8 for macOS",
        "gdw": "Whether the request is coming from GD World. Not sent outside of GDW. This used to block some requests if set to <code>1</code>, and used to be sent as <code>0</code> in full GD 2.1",
